...
#define B_SMART_WILD_AI_FLAG        FLAG_Z_ENABLE_SMART_WILD_MONS     // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           FLAG_Z_NO_BATTLE_BAG     // If this flag is set, the ability to use the bag in battle is disabled.
